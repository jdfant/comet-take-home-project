...
| Name | Description |
|------|-------------|
| <a name="output_availability_zones"></a> [availability\_zones](#output\_availability\_zones) | A list of Availability Zones where the nodes/node groups will be provisioned |
...
| <a name="output_eks_vpc_id"></a> [eks\_vpc\_id](#output\_eks\_vpc\_id) | ID of the VPC where the cluster security group will be provisioned |
...
| <a name="output_subnet_ids"></a> [subnet\_ids](#output\_subnet\_ids) | A list of subnet IDs where the nodes/node groups will be provisioned |
<!-- END_TF_DOCS -->